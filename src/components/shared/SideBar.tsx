            ...
            <div className="h-full rounded-lg px-3 py-4 overflow-y-auto bg-[#1C2C3B] text-white dark:bg-gray-800">
               <div className='mb-4'>
                  <Link href='/' className='flex items-center gap-4'>
                     <Image src='/category.gif' className='w-12 h-12' width={20} height={20} alt='logo' />
                     <span className='grid'>
               ...
               <ul className="space-y-2 font-medium">
                  ...
                  <li>
                     <Link href="/categorias" className="flex items-center p-2 text-gray-500 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <li>
                     <a href="#" className="flex items-center p-2 text-gray-500 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">My Lidrary</span>
